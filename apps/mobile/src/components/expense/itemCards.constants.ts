/** Constants for the item cards (the itemized split editor). */
...
/** Alpha suffix (8-digit hex) that turns a person's avatar colour into a chip wash. */
export const CHIP_TINT_ALPHA = "1f";
