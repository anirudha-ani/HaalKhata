...
export function useExpenseDetail(expenseId: string) {
  ...
  return {
    ...
    /**
     * The edits and the deletion, so the page can decide whether a history is
     * worth showing at all. Every expense has a creation event; only a later
     * change makes the section say anything.
     */
