 ...
 * either the itemized line-item editor or a per-person list with
 * participation checkboxes and (for non-equal splits) value inputs, plus the
 * split validation message or the equal-split per-person summary.
 *
...
export function SplitEditor({
  ...
  /** ISO 4217 currency code used to format itemized totals. */
  currency: string;
}) {
  return (
    <section className="space-y-3">
      ...
      {form.isItemized ? (
        <ItemizedEditor form={form} currency={currency} />
      ) : (
