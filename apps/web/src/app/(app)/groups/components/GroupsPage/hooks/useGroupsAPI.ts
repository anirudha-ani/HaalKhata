"use client";
/** TanStack Query bindings for the groups route: list groups, list friends, create group. */
...
/**
 * Wraps every server call the groups page makes: the group-list query, the
 ...
 *   query, and the `createGroup` mutation.
 */
